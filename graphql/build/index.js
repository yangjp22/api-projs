...
const resolvers = {
  Query: {
    user: (parent, {
      ...
      return _db__WEBPACK_IMPORTED_MODULE_1__["users"].find(item => item.id === id);
    },
    users: (parent, args, context, info) => {
      return _db__WEBPACK_IMPORTED_MODULE_1__["users"];
    }
  },
  Mutation: {
    createUser: (parent, {
    ...
    updateUser: (parent, {
      ...
      let newUser = _db__WEBPACK_IMPORTED_MODULE_1__["users"].find(item => item.id === id);
      newUser.name = name;
      newUser.email = email;
      newUser.age = age;
      return newUser;
    ...
    deleteUser: (parent, {
      ...
      const userIndex = _db__WEBPACK_IMPORTED_MODULE_1__["users"].findIndex(item => item.id === id);
      if (userIndex === -1) throw new Error("User not found...");
      let newUser = _db__WEBPACK_IMPORTED_MODULE_1__["users"][userIndex];
      _db__WEBPACK_IMPORTED_MODULE_1__["users"].splice(userIndex, 1);
      return newUser;
    }
  }
};
